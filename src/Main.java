...
import Assets.Views.Startup.Splash;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(HashUtil.hashString("aya123"));

        System.out.println("[Serenity] : Starting main thread \uD83D\uDC4B\uD83C\uDFFB");



        Assets.Database.ProductManager productManager = new Assets.Database.ProductManager();
